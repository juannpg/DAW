CREATE DATABASE IF NOT EXISTS transporte_ferroviario;
USE transporte_ferroviario;

CREATE TABLE IF NOT EXISTS clase (
	codigo	INT(11) NOT NULL AUTO_INCREMENT,
	nombre	VARCHAR(60) NOT NULL,
	consumo_minimo_anual	FLOAT NOT NULL,
	porcentaje_adicional	INT(11) NOT NULL,
	PRIMARY KEY(codigo)
);
...
CREATE TABLE IF NOT EXISTS viajero (
	...
	lugar_residencia	VARCHAR(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS estacion (
	...
	agno_inauguracion	INT(4) NOT NULL,
	vias	INT(4) NOT NULL,
	PRIMARY KEY(codigo)
);
...
CREATE TABLE IF NOT EXISTS billete (
	codigo	INT(11) NOT NULL AUTO_INCREMENT,
	codigo_viajero	INT(11) NOT NULL,
	codigo_estacion_origen	INT(11) NOT NULL,
	codigo_estacion_destino	INT(11) NOT NULL,
	...
	CONSTRAINT UC_BILLETE UNIQUE (codigo_viajero,codigo_estacion_origen,codigo_estacion_destino,fecha,hora_salida,hora_llegada),	
	PRIMARY KEY(codigo)
);
